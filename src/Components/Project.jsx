...
return(
  ...
  <img src="/images/nick-chong-N__BnvQ_w18-unsplash.jpg" alt="STOCK" loading="lazy" className="project_img"></img>
<a href="https://github.com/pmi0603/Stock_Prediction" target="_blank" rel="noopener noreferrer">STOCK PRICE PREDICTION</a>
</div>

<div className="project_link">
    <img src="/images/national-cancer-institute-pCqzMe04s8g-unsplash.jpg" alt="DISEASE" loading="lazy" className="project_img"></img> 
    <a href="https://github.com/pmi0603/Disease-Prediction" target="_blank" rel="noopener noreferrer">DISEASE PREDICTION</a>
</div>

<div className="project_link">
    <img src="/images/rubaitul-azad-qqV7i39Ekj0-unsplash.jpg" alt="AUDIO" loading="lazy" className="project_img"></img>
    <a href="https://github.com/pmi0603/Audio-Translator" target="_blank" rel="noopener noreferrer">AUDIO TRANSLATOR</a>
</div>

<div className="project_link">
    <img src="/images/dad-hotel-Y-bJWAjPzsY-unsplash.jpg" alt="HOTEL" loading="lazy" className="project_img"></img>
